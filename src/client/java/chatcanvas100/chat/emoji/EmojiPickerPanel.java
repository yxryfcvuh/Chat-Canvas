...
import chatcanvas100.mixin.client.ChatInputSuggestorAccessor;
import chatcanvas100.mixin.client.SuggestionWindowAccessor;
import chatcanvas100.mixin.client.TextFieldWidgetAccessor;
...
public final class EmojiPickerPanel {
	...
	private void insert(EmojiEntry entry) {
		...
		inputController.capture(
				chatcanvas100.chat.input.ChatCanvasInputMode.PLAYER_CHAT,
