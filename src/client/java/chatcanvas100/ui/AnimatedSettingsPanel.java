...
import chatcanvas100.animation.MotionPreset;
import chatcanvas100.animation.SpringValue;
import chatcanvas100.chat.render.PreviewChatState;
import chatcanvas100.chat.notification.MentionNotificationController;
import chatcanvas100.config.ChatTextAlignment;
...
import chatcanvas100.config.MessageBackgroundMode;
import chatcanvas100.config.MentionConfig;
import chatcanvas100.config.MentionSound;
import chatcanvas100.config.PlayerColorConfig;
import chatcanvas100.config.PlayerColorMode;
import chatcanvas100.config.PlayerChatLayoutMode;
import chatcanvas100.voice.VoiceInputManager;
import chatcanvas100.voice.VoiceInputState;
import chatcanvas100.voice.VoiceSettings;
...
import chatcanvas100.chat.identity.PlayerNameColorProvider;
...
public final class AnimatedSettingsPanel {
	...
	private void selectPlayerLayout(PlayerChatLayoutMode mode) {
		if (session.selectedChannel() != chatcanvas100.editor.EditorChannel.PLAYER_CHAT
	...
	private void syncPlayerLayoutButtons() {
		boolean player = session.selectedChannel()
				== chatcanvas100.editor.EditorChannel.PLAYER_CHAT;
