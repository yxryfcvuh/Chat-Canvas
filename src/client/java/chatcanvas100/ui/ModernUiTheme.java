...
public final class ModernUiTheme {
    ...
    private static void drawVanillaPanel(OwoUIGraphics context, int x, int y, int w, int h) {
    ...
    public static void shadow(OwoUIGraphics context, int x, int y, int width, int height) {
        roundedRect(context, x - 3, y + 4, width + 6, height + 4, 8, 0x32000000);
        roundedRect(context, x - 1, y + 2, width + 2, height + 2, 7, 0x45000000);
    }

    public static void roundedRect(OwoUIGraphics context, int x, int y,
    ...
    public static void border(OwoUIGraphics context, int x, int y,
