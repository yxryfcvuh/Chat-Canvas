...
import chatcanvas100.chat.render.ChatRenderContext;
import chatcanvas100.chat.render.ChatRenderEngine;
import chatcanvas100.chat.render.PreviewChatMessage;
...
import chatcanvas100.editor.EditorChannel;
import chatcanvas100.editor.LayoutEditorMath;
	...
	public void draw(OwoUIGraphics context, int mouseX, int mouseY, float partialTicks, float delta) {
		...
		renderEngine.render(new ChatRenderContext(
				...
				channel == EditorChannel.PLAYER_CHAT
						...
						: chatcanvas100.config.PlayerChatLayoutMode.CLASSIC,
